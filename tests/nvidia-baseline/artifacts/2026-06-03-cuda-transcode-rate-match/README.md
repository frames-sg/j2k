...
2026-06-04 from branch `codex/cuda-htj2k-batch-callers`.
...
| --- | --- | --- |
| `level1-rate-match.json` | 9/7, 1 decomposition level, quant scale 1.90 | Signinum CUDA HT: 457.7 MP/s, NVIDIA reused-session serial: 54.2 MP/s |
| `level2-rate-match.json` | 9/7, 2 decomposition levels, quant scale 1.00 | Signinum CUDA HT: 69.6 MP/s, NVIDIA reused-session serial: 55.6 MP/s |
