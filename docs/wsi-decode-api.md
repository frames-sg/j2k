...
four-component fixture coverage, and lossless SOF3 color/row plus
non-grayscale restart coverage remain structured unsupported or
...
16-bit streams, including restart-coded grayscale streams.
...
non-constant 12-bit oracle fixtures, and broader SOF3 color/row CPU parity must land
