...
| --- | --- | --- |
| `0.7.6` | Planned `j2k-ml` adoption release with explicitly staged CUDA/Metal upload adapters; not publishable until clean-consumer, exact-SHA, benchmark, and hardware gates pass. | Not a release line. |
...
unaffected. The planned `0.7.6` adapters instead perform accelerator codec
