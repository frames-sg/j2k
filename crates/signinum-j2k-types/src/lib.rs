//! Shared JPEG 2000 encode-stage contract types for signinum.
//!
//! This crate is the neutral public contract between the `signinum-j2k`
//! adapter surface and the `signinum-j2k-native` codec engine: job, output,
...
//! codec behavior stays in `signinum-j2k-native` and adapter traits stay in
//! their owning crates.
