...
//! Decompress a zlib-wrapped Deflate tile payload through the facade crate.
//!
//! Run with:
//! `cargo run -p signinum --example tile_decompress`

use flate2::{write::ZlibEncoder, Compression};
use signinum::{tilecodec::DeflateCodec, tilecodec::DeflatePool, TileDecompress};
use std::io::Write;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("decoded {written} bytes through signinum::tilecodec");
    Ok(())
}
