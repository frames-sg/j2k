...
use signinum_j2k_native::{encode, DecodeSettings, EncodeOptions, Image};
...
fn strict_decode(codestream: &[u8]) -> signinum_j2k_native::Result<signinum_j2k_native::RawBitmap> {
    Image::new(
        codestream,
        &DecodeSettings {
            strict: true,
