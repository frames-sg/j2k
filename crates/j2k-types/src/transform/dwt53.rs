...
//! Reversible 5/3 forward-wavelet contracts.

use alloc::vec::Vec;

/// Forward reversible 5/3 DWT job.
...
/// Forward reversible 5/3 DWT output.
#[derive(Debug)]
...
/// One reversible 5/3 DWT detail level.
#[derive(Debug)]
...
crate::move_only::assert_move_only!(J2kForwardDwt53Output, J2kForwardDwt53Level);
