...
pub(crate) const CUDA_IDWT_TRACE_ENV_VAR: &str = "SIGNINUM_CUDA_IDWT_TRACE";
...
pub(crate) const J2K_ENCODE_PTX_BUILT_FROM_CUDA: bool = cfg!(signinum_cuda_j2k_encode_ptx_built);

pub(crate) const HTJ2K_ENCODE_PTX_BUILT_FROM_CUDA: bool =
    cfg!(signinum_cuda_htj2k_encode_ptx_built);
...
pub(crate) const TRANSCODE_PTX_BUILT_FROM_CUDA: bool = cfg!(signinum_cuda_transcode_ptx_built);
