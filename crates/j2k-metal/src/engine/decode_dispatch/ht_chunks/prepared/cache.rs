...
use crate::engine::{Error, MetalRuntime};
...
pub(in crate::engine) struct PreparedMetalHtExecutionCache {
...
impl PreparedMetalHtExecutionCache {
    pub(in crate::engine) const fn new() -> Self {
        Self {
            entries: Vec::new(),
...
pub(in crate::engine) fn prepared_metal_ht_execution(
