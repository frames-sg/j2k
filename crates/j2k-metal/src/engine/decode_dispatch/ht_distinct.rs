...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_distinct_ht_sub_bands_to_buffer_in_command_buffer(
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_distinct_ht_sub_bands_to_buffer_in_encoder(
    runtime: &MetalRuntime,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_distinct_ht_sub_band_groups_to_buffer_in_command_buffer(
    runtime: &MetalRuntime,
    command_buffer: &CommandBufferRef,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_distinct_ht_sub_band_groups_to_buffer_in_encoder(
    runtime: &MetalRuntime,
    encoder: &crate::metal_types::ComputeCommandEncoderRef,
    groups: &[&PreparedHtSubBandGroup],
    output: &Buffer,
...
#[cfg(target_os = "macos")]
#[derive(Clone, Copy)]
pub(in crate::engine) struct DistinctHtBatch<'a> {
    pub(in crate::engine) payload: super::HtPayloadSource<'a>,
    pub(in crate::engine) jobs: &'a [J2kHtCleanupBatchJob],
    pub(in crate::engine) output_base: usize,
    pub(in crate::engine) execution_owner:
        &'a std::sync::Arc<crate::engine::PreparedHtExecutionOwner>,
}
