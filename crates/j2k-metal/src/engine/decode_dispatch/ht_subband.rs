...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn required_ht_output_len(
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_repeated_ht_sub_band_to_buffer_in_command_buffer(
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_repeated_ht_sub_band_group_to_buffer_in_command_buffer(
    runtime: &MetalRuntime,
    command_buffer: &CommandBufferRef,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_prepared_ht_sub_band_to_buffer_in_encoder(
    runtime: &MetalRuntime,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_prepared_ht_sub_band_group_to_buffer_in_encoder(
    runtime: &MetalRuntime,
    encoder: &ComputeCommandEncoderRef,
    group: &PreparedHtSubBandGroup,
    output: &Buffer,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn ht_output_word_count(
    output_offset: u32,
    output_stride: u32,
    width: u32,
    height: u32,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn ht_batch_output_word_count(
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn dispatch_zero_u32_buffer_in_encoder(
    runtime: &MetalRuntime,
    encoder: &ComputeCommandEncoderRef,
    buffer: &Buffer,
    word_count: usize,
