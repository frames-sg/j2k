...
use crate::engine::direct_surface_pack::checked_metal_surface_len;
#[cfg(target_os = "macos")]
mod destination;

#[cfg(target_os = "macos")]
pub(in crate::engine) use self::destination::{
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn dispatch_store_component_buffer_in_command_buffer_with_offsets(
...
pub(in crate::engine) fn dispatch_store_component_repeated_in_command_buffer(
    runtime: &MetalRuntime,
    command_buffer: &CommandBufferRef,
    input: &Buffer,
    input_offset_bytes: usize,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn repeated_gray_store_is_contiguous_full_surface(
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_repeated_gray_store_to_surfaces_in_command_buffer(
    runtime: &MetalRuntime,
    command_buffer: &CommandBufferRef,
    input: &Buffer,
    params: J2kRepeatedGrayStoreParams,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_gray_store_to_surface_in_encoder(
    runtime: &MetalRuntime,
    encoder: &ComputeCommandEncoderRef,
    input: &Buffer,
    input_offset_bytes: usize,
