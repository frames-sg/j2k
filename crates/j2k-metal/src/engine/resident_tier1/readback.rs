...
#[cfg(target_os = "macos")]
#[derive(Clone, Copy)]
pub(in crate::engine) struct ResidentTier1StatusReadbackRequest<'a> {
    ...
    pub(in crate::engine) classic_jobs: Option<&'a [J2kClassicEncodeBatchJob]>,
    pub(in crate::engine) count: usize,
    pub(in crate::engine) status_size: usize,
    pub(in crate::engine) profile_stages: bool,
}

#[cfg(target_os = "macos")]
impl<'a> ResidentTier1StatusReadbackRequest<'a> {
    pub(in crate::engine) fn high_throughput(
    ...
    pub(in crate::engine) fn classic(
        runtime: &'a MetalRuntime,
        command_buffer: &'a CommandBufferRef,
        status_buffer: &'a Buffer,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn schedule_resident_tier1_status_readback(
