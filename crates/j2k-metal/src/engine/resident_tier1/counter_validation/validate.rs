...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn compare_classic_tier1_symbol_plan_and_pass_plan_counters(
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn record_classic_tier1_token_emit_counters(
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn compare_classic_tier1_symbol_plan_and_token_emit_counters(
    symbol_plan: &J2kResidentClassicTier1SymbolPlanReadback,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn validate_classic_tier1_split_token_emit_counters(
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn compare_classic_tier1_symbol_plan_and_split_token_emit_counters(
    symbol_plan: &J2kResidentClassicTier1SymbolPlanReadback,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn profile_classic_tier1_token_pack(
    stage_stats: &mut J2kResidentEncodeStageStats,
    readback: &J2kResidentClassicTier1TokenEmitReadback,
) -> Result<(), Error> {
