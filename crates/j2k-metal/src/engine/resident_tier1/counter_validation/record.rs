...
pub(in crate::engine) fn record_classic_tier1_density_counters(
...
pub(in crate::engine) fn record_classic_tier1_symbol_plan_counters(
    stage_stats: &mut J2kResidentEncodeStageStats,
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn record_classic_tier1_pass_plan_counters(
    stage_stats: &mut J2kResidentEncodeStageStats,
