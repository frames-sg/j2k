...
impl PreparedDirectGrayscalePlan {
    pub(in crate::engine) fn classic_group_starting_at(
        &self,
        step_idx: usize,
    ...
    pub(in crate::engine) fn ht_group_starting_at(
        &self,
        step_idx: usize,
...
#[cfg(test)]
pub(in crate::engine) fn prepared_direct_grayscale_plan_compute_encoder_count(
...
#[cfg(test)]
pub(in crate::engine) fn prepared_repeated_direct_ht_cleanup_dispatch_count(
    plan: &PreparedDirectGrayscalePlan,
) -> usize {
