...
use crate::engine::direct_stacked_batch::DirectBandSlice;
use crate::engine::PreparedDirectGrayscaleStep;
...
#[cfg(target_os = "macos")]
pub(in crate::engine) fn encode_repeated_direct_grayscale_plan_in_command_buffer(
