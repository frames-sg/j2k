...
use super::{
    ...
    new_private_buffer, new_shared_buffer, packet_tree_node_count, size_of, split_u64_words,
...
fn submit_resident_single_plan<T: ResidentLosslessTier1Metal>(
    ...
    Ok(J2kPendingResidentLosslessCodestream {
        ...
        command_buffer,
        retained_command_buffers: crate::batch_allocation::try_vec_from_array(
            [
                tier1.prepare_command_buffer().clone(),
                tier1.tier1_command_buffer().clone(),
            ],
            "J2K Metal resident single retained command buffers",
        )?,
        _retained_buffers: crate::batch_allocation::try_vec_from_array(
            [
                resolution_buffer,
                subband_buffer,
            ...
            "J2K Metal resident single retained buffers",
        )?,
...
mod tests {
    ...
    use super::*;
    use crate::engine::{J2kResidentPacketizationResolution, J2kResidentPacketizationSubband};
