...
pub(in crate::engine) struct BatchPrepareItemRequest<'a, 'job> {
    pub(in crate::engine) runtime: &'a MetalRuntime,
    pub(in crate::engine) item: J2kLosslessDeviceBatchPrepareItem<'job>,
    pub(in crate::engine) item_sizes: J2kLosslessPrepareSizes,
    pub(in crate::engine) coefficient_buffer: &'a Buffer,
    pub(in crate::engine) coefficient_byte_offset: usize,
    pub(in crate::engine) split_prepare_command_buffers: bool,
    pub(in crate::engine) shared_command_buffer: &'a Option<CommandBuffer>,
    pub(in crate::engine) shared_recyclable_private_buffers:
...
pub(in crate::engine) fn prepare_lossless_batch_item(
