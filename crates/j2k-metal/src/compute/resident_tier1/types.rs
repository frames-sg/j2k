...
pub(crate) struct J2kPreparedLosslessDeviceCodeBlocks {
    ...
    pub(in crate::compute) recyclable_private_buffers: Vec<crate::buffer_pool::PooledBuffer>,
...
pub(crate) struct J2kPendingResidentLosslessCodestreamBatch {
    ...
    pub(in crate::compute) recyclable_private_buffers: Vec<crate::buffer_pool::PooledBuffer>,
    pub(in crate::compute) recyclable_shared_buffers: Vec<crate::buffer_pool::PooledBuffer>,
