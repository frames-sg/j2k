    ...
    for step in &plan.steps {
        match step {
            ...
            J2kDirectGrayscaleStep::Store(store) => {
                ...
                let job = j2k_native::J2kStoreComponentJob {
                    input,
...
mod tests {
    ...
    fn ht_plan() -> j2k_native::J2kDirectGrayscalePlan {
        let pixels: Vec<u8> = (0..16).collect();
        let options = EncodeOptions {
            reversible: true,
            num_decomposition_levels: 1,
    ...
    struct CaptureIdwtJob {
        rect: Option<j2k_native::J2kRect>,
        ll_rect: Option<j2k_native::J2kRect>,
        hl_rect: Option<j2k_native::J2kRect>,
        lh_rect: Option<j2k_native::J2kRect>,
        hh_rect: Option<j2k_native::J2kRect>,
        ll: Vec<f32>,
        hl: Vec<f32>,
        lh: Vec<f32>,
        hh: Vec<f32>,
