...
fn reject_non_cuda_encode_backend(encoded: &j2k::EncodedJ2k) -> Result<(), crate::Error> {
...
pub struct SubmittedJ2kLosslessCudaEncode {
    inner: ReadySubmission<j2k::EncodedJ2k, crate::Error>,
}
...
pub struct SubmittedJ2kLosslessCudaEncodeBatch {
    inner: ReadySubmission<Vec<j2k::EncodedJ2k>, crate::Error>,
}
...
struct CudaEncodedHtSubband {
    quantize_dispatches: usize,
    encode: j2k_cuda_runtime::CudaHtj2kEncodedCodeBlocks,
    timings: CudaEncodeStageTimings,
}
