...
fn dct97_benchmark_emits_transcode_batch_profile_rows() {
    for expected in [
        ...
        "j2k_profile codec=transcode op=transcode_batch request={}",
        ...
        "context={context}",
        "transcode_transform_processor(request, &timings)",
        "transcode_timings_indicate_metal_work",
        "transcode_profile_path",
