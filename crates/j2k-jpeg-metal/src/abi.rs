...
impl_gpu_readback_abi!(
    ...
    JpegBaselineEncodeHuffmanTable {
        codes: [u16; 256],
        lens: [u8; 256],
    },
    ...
    JpegFastRegionScaledBatchParams {
        scaled_width: u32,
        scaled_height: u32,
        chroma_width: u32,
        chroma_height: u32,
