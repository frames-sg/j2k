...
use super::super::{
    batch, commit_and_wait_jpeg, dispatch_2d_pipeline, BatchDeviceBufferCache, Buffer, BufferError,
    ...
    JpegWindowedTexturePackBatchParams, MTLPixelFormat, MTLResourceOptions, MetalRuntime,
    PixelFormat, PlaneMode, Rect, Surface, MODE_GRAY, MODE_RGB, MODE_YCBCR, OUT_GRAY, OUT_RGB,
    OUT_RGBA,
};
#[cfg(test)]
use super::super::{
...
pub(in crate::compute) struct FastSubsampledScaledRegionBatchItemRequest<'a, P: FastSubsampledMetal>
{
    ...
    pub(in crate::compute) request_index: usize,
...
#[cfg(all(target_os = "macos", test))]
pub(in crate::compute) fn encode_split_coeff_idct_passes(request: SplitCoeffIdctPasses<'_>) {
