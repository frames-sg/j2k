...
extern "C" __global__ void j2k_htj2k_encode_codeblock(
    const int *coefficients,
    uchar *out,
...
extern "C" __global__ void j2k_htj2k_encode_codeblocks(
    const int *coefficients,
    uchar *out,
...
extern "C" __global__ void __launch_bounds__(J2K_HT_ENCODE_THREADS) j2k_htj2k_encode_codeblocks_multi_input(
    uchar *out,
...
extern "C" __global__ void __launch_bounds__(J2K_HT_ENCODE_THREADS) j2k_htj2k_encode_codeblocks_multi_input_cleanup(
    uchar *out,
    const J2kHtEncodeMultiInputJob *jobs,
    const ushort *vlc_table0,
    const ushort *vlc_table1,
...
extern "C" __global__ void __launch_bounds__(J2K_HT_ENCODE_THREADS) j2k_htj2k_encode_codeblocks_multi_input_cleanup_64(
    uchar *out,
    const J2kHtEncodeMultiInputJob *jobs,
    const ushort *vlc_table0,
    const ushort *vlc_table1,
...
extern "C" __global__ void j2k_htj2k_compact_codeblocks(
    const uchar *scratch,
    uchar *compact,
...
extern "C" __global__ void j2k_htj2k_packetize_cleanup(
    const uchar *payload,
    unsigned long long payload_len,
