...
extern "C" __global__ void j2k_inverse_dwt_single(
    const float *ll,
    const float *hl,
    const float *lh,
    const float *hh,
...
extern "C" __global__ void j2k_idwt_interleave(
    const float *ll,
    const float *hl,
    const float *lh,
    const float *hh,
...
extern "C" __global__ void j2k_idwt_interleave_multi(
...
extern "C" __global__ void j2k_idwt_interleave_horizontal_multi(
    const CudaJ2kIdwtMultiJob *jobs
) {
...
extern "C" __global__ void j2k_idwt_interleave_horizontal_53_multi(
    const CudaJ2kIdwtMultiJob *jobs
) {
...
extern "C" __global__ void j2k_idwt_interleave_horizontal_97_multi(
    const CudaJ2kIdwtMultiJob *jobs
) {
    __shared__ float row_samples[512];
...
extern "C" __global__ void j2k_idwt_horizontal(
    float *output,
    const CudaJ2kIdwtJob *job_buffer
) {
    const CudaJ2kIdwtJob job = job_buffer[0];
...
extern "C" __global__ void j2k_idwt_horizontal_53(
    float *output,
    const CudaJ2kIdwtJob *job_buffer
) {
    const CudaJ2kIdwtJob job = job_buffer[0];
...
extern "C" __global__ void j2k_idwt_horizontal_97(
    float *output,
    const CudaJ2kIdwtJob *job_buffer
) {
    const CudaJ2kIdwtJob job = job_buffer[0];
...
extern "C" __global__ void j2k_idwt_horizontal_multi(
    const CudaJ2kIdwtMultiJob *jobs
) {
    const uint job_idx = blockIdx.y;
    const CudaJ2kIdwtMultiJob item = jobs[job_idx];
...
extern "C" __global__ void j2k_idwt_vertical(
    float *output,
    const CudaJ2kIdwtJob *job_buffer
) {
    const CudaJ2kIdwtJob job = job_buffer[0];
...
extern "C" __global__ void j2k_idwt_vertical_53(
    float *output,
    const CudaJ2kIdwtJob *job_buffer
) {
    const CudaJ2kIdwtJob job = job_buffer[0];
...
extern "C" __global__ void j2k_idwt_vertical_97(
    float *output,
    const CudaJ2kIdwtJob *job_buffer
) {
    const CudaJ2kIdwtJob job = job_buffer[0];
...
extern "C" __global__ void j2k_idwt_vertical_multi(
    const CudaJ2kIdwtMultiJob *jobs
) {
    const uint job_idx = blockIdx.y;
    const CudaJ2kIdwtMultiJob item = jobs[job_idx];
...
extern "C" __global__ void j2k_idwt_vertical_53_multi(
    const CudaJ2kIdwtMultiJob *jobs
) {
...
extern "C" __global__ void j2k_idwt_vertical_97_multi(
    const CudaJ2kIdwtMultiJob *jobs
) {
    __shared__ float column_samples[512];
...
extern "C" __global__ void j2k_idwt_vertical_97_multi_cols4(
    const CudaJ2kIdwtMultiJob *jobs
) {
...
extern "C" __global__ void j2k_store_gray8(
    const float *input,
    uchar *output,
...
extern "C" __global__ void j2k_store_gray16(
    const float *input,
    ushort *output,
...
extern "C" __global__ void j2k_inverse_mct(
    float *plane0,
    float *plane1,
    float *plane2,
...
extern "C" __global__ void j2k_store_rgb8(
    const float *plane0,
    const float *plane1,
    const float *plane2,
    uchar *output,
...
extern "C" __global__ void j2k_store_rgb16(
    const float *plane0,
    const float *plane1,
    const float *plane2,
    ushort *output,
...
extern "C" __global__ void j2k_store_rgb8_mct(
    const float *plane0,
    const float *plane1,
    const float *plane2,
    uchar *output,
...
extern "C" __global__ void j2k_store_rgb8_mct_batch(
...
extern "C" __global__ void j2k_store_rgb16_mct(
    const float *plane0,
    const float *plane1,
    const float *plane2,
    ushort *output,
...
extern "C" __global__ void j2k_htj2k_decode_codeblocks(
    const uchar *coded_data,
    uint *decoded_data,
...
extern "C" __global__ void j2k_htj2k_decode_codeblocks_multi(
    const uchar *coded_data,
...
extern "C" __global__ void j2k_htj2k_decode_codeblocks_multi_cleanup_only(
    const uchar *coded_data,
    const J2kHtCleanupMultiBatchJob *jobs,
    const ushort *vlc_table0,
    const ushort *vlc_table1,
...
extern "C" __global__ void j2k_dequantize_htj2k_codeblocks(
    uint *decoded_data,
    const J2kHtCleanupBatchJob *jobs
) {
...
extern "C" __global__ void j2k_dequantize_htj2k_codeblocks_multi(
...
extern "C" __global__ void j2k_dequantize_htj2k_cleanup_jobs_multi(
    const J2kHtCleanupMultiBatchJob *jobs
) {
    const uint job_idx = blockIdx.x;
