...
//!
//! Set `J2K_NDPI_PATH=/path/to/slide.ndpi` to run this test against a
//! local slide. The test reads TIFF directories and compressed JPEG payloads;
//! it does not decode the whole-slide image. Set `J2K_NDPI_TILE_LIMIT=0`
//! to validate every JPEG payload in the container.

use j2k_core::{CodedUnitLayout, Colorspace, Info as CoreInfo};
use j2k_jpeg::{
...
const NDPI_PATH_ENV: &str = "J2K_NDPI_PATH";
const REQUIRE_NDPI_ENV: &str = "J2K_REQUIRE_NDPI";
const TILE_LIMIT_ENV: &str = "J2K_NDPI_TILE_LIMIT";
const MAX_PAYLOAD_BYTES_ENV: &str = "J2K_NDPI_MAX_PAYLOAD_BYTES";
