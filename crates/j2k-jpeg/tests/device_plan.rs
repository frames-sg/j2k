...
fn lossless_3x3_ops() -> [JpegDecodeOp; 4] {
    standard_ops(lossless_3x3_roi(), lossless_3x3_roi())
}

fn lossless_3x3_roi_and_scaled_ops() -> [JpegDecodeOp; 3] {
    [
...
fn lossless_3x3_region_scaled_op() -> JpegDecodeOp {
    JpegDecodeOp::RegionScaled {
