...
pub use encode::{
    ...
    submit_lossless_from_metal_buffers, submit_lossless_from_metal_buffers_with_config,
    submit_lossless_from_padded_metal_buffer, submit_lossless_from_padded_metal_buffers,
