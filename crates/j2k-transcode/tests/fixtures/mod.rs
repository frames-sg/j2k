...
pub(crate) fn grayscale_8x8_jpeg() -> Vec<u8> {
    j2k_test_support::jpeg_grayscale_8x8()
}
...
pub(crate) fn baseline_444_8x8_rgb() -> Vec<u8> {
    j2k_test_support::jpeg_baseline_444_8x8_rgb()
}
...
pub(crate) fn baseline_422_16x8_rgb() -> Vec<u8> {
    j2k_test_support::jpeg_baseline_422_16x8_rgb()
}
...
pub(crate) fn baseline_420_restart_32x16_rgb() -> Vec<u8> {
    j2k_test_support::jpeg_baseline_420_restart_32x16_rgb()
}
