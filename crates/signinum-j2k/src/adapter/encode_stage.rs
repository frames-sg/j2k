...
//! `signinum-j2k-native` through the neutral `signinum-j2k-types` contract
...
///
/// With the shared `signinum-j2k-types` contract this is a direct
...
mod tests {
    ...
    fn native_adapter_forwards_dispatch_report() {
        ...
        let report = signinum_j2k_native::J2kEncodeStageAccelerator::dispatch_report(&adapter);
