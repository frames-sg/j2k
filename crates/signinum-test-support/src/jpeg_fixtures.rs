...
//! committed under `signinum-test-support/fixtures/conformance/` and embedded
...
const LOSSLESS_RGB_16BIT_422_4X2_C2: [u16; 4] = [50000, 49880, 50025, 49920];

const LOSSLESS_YCBCR_16BIT_422_4X2_C0: [u16; 8] =
...
const LOSSLESS_RGB_16BIT_420_4X4_C0: [u16; 16] = [
    33000, 33012, 33025, 33045, 32990, 33020, 33044, 33070, 33010, 33034, 33058, 33082, 32980,
    33016, 33052, 33088,
];
const LOSSLESS_RGB_16BIT_420_4X4_C1: [u16; 4] = [16000, 16100, 16055, 16140];
const LOSSLESS_RGB_16BIT_420_4X4_C2: [u16; 4] = [50000, 49880, 50025, 49920];

const LOSSLESS_YCBCR_16BIT_420_4X4_C0: [u16; 16] = [
    33000, 33120, 33280, 33420, 32940, 33080, 33300, 33460, 33030, 33160, 33310, 33470, 32970,
    33110, 33340, 33490,
];
const LOSSLESS_YCBCR_16BIT_420_4X4_C1: [u16; 4] = [35000, 34600, 35200, 34720];
const LOSSLESS_YCBCR_16BIT_420_4X4_C2: [u16; 4] = [40000, 39250, 40250, 39440];
...
fn ycbcr8_pixels_to_rgb8(samples: &[u8]) -> Vec<u8> {
...
fn ycbcr8_to_rgb8_for_fixture(y: u8, cb: u8, cr: u8) -> (u8, u8, u8) {
    const FIX_1_40200: i32 = 91_881;
    const FIX_0_34414: i32 = 22_554;
    const FIX_0_71414: i32 = 46_802;
    const FIX_1_77200: i32 = 116_130;
...
fn lossless_420_planes_to_rgb16(
    color_space: ColorSpaceFixture,
    width: usize,
    height: usize,
    c0: &[u16],
...
fn upsample_h2v2_16bit_for_fixture(
    plane: &[u16],
    chroma_width: usize,
    chroma_height: usize,
    output_width: usize,
