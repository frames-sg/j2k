...
fn htj2k_options(reversible: bool) -> signinum_j2k_native::EncodeOptions {
...
fn encode_htj2k_fixture(
    ...
    signinum_j2k_native::encode_htj2k(
        pixels,
        width,
        height,
        components,
...
pub fn htj2k_gray8_large_fixture(width: u32, height: u32) -> Vec<u8> {
    ...
    signinum_j2k_native::encode_htj2k(&pixels, width, height, 1, 8, false, &options)
...
pub fn classic_j2k_gray8_fixture(width: u32, height: u32) -> Vec<u8> {
    ...
    signinum_j2k_native::encode(&pixels, width, height, 1, 8, false, &options)
