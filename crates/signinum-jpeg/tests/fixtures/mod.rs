...
pub(crate) const LOSSLESS_YCBCR_3X3_PIXELS: [u8; 27] = [
...
pub(crate) fn lossless_rgb_16bit_422_4x2_rgb16() -> Vec<u8> {
...
pub(crate) fn lossless_rgb_16bit_420_4x4_jpeg(predictor: u8) -> Vec<u8> {
...
pub(crate) fn lossless_rgb_16bit_420_restart_4x4_jpeg(predictor: u8) -> Vec<u8> {
...
pub(crate) fn lossless_rgb_16bit_420_4x4_rgb16() -> Vec<u8> {
...
pub(crate) fn lossless_predictor_ycbcr_3x3_jpeg(predictor: u8) -> Vec<u8> {
...
pub(crate) fn lossless_restart_predictor_ycbcr_3x3_jpeg(predictor: u8) -> Vec<u8> {
...
pub(crate) fn lossless_ycbcr_16bit_422_4x2_jpeg(predictor: u8) -> Vec<u8> {
    lossless_color_16bit_422_jpeg(
        None,
        4,
        2,
...
pub(crate) fn lossless_ycbcr_16bit_422_4x2_rgb16() -> Vec<u8> {
    lossless_422_planes_to_rgb16(
...
pub(crate) fn lossless_ycbcr_16bit_420_4x4_jpeg(predictor: u8) -> Vec<u8> {
    lossless_color_16bit_420_jpeg(
        None,
        4,
        4,
...
pub(crate) fn lossless_ycbcr_16bit_420_restart_4x4_jpeg(predictor: u8) -> Vec<u8> {
    lossless_color_16bit_420_restart_jpeg(
        None,
        4,
        4,
...
pub(crate) fn lossless_ycbcr_16bit_420_4x4_rgb16() -> Vec<u8> {
    lossless_420_planes_to_rgb16(
        ColorSpaceFixture::YCbCr,
        4,
        4,
...
pub(crate) fn cmyk_16x16_420_jpeg() -> Vec<u8> {
...
pub(crate) fn four_component_16x16_rgb() -> Vec<u8> {
    vec![64; 16 * 16 * 3]
}
