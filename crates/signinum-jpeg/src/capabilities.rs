...
use signinum_core::{BackendRequest, Downscale, PixelFormat};
...
pub enum JpegResolvedDecodePath {
    ...
    CpuHost,
    /// Signinum-owned CUDA RGB8 decode path.
    OwnedCudaRgb8,
    /// Signinum Metal fast-packet decode path.
    MetalFast,
                ...
                if self.owned_cuda.eligible {
                    ...
                    JpegResolvedDecodePath::Rejected {
                        ...
                        reason: self
                            .owned_cuda
                            .reason
                            .unwrap_or("Signinum-owned CUDA JPEG decode rejected this request"),
                    }
                }
            }
