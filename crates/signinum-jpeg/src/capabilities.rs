            ...
            ) =>
        {
            return match (info.color_space, info.bit_depth, request.fmt) {
                ...
                | (ColorSpace::Rgb, 16, PixelFormat::Rgb16 | PixelFormat::Rgba16) => JpegBackendEligibility::rejected(
                    "JPEG CPU lossless SOF3 APP14 RGB decode currently supports 4:4:4 sampling, even-width 16-bit 4:2:2 sampling, or even-dimension 16-bit 4:2:0 sampling",
                ),
                ...
                | (ColorSpace::YCbCr, 16, PixelFormat::Rgb16 | PixelFormat::Rgba16) => JpegBackendEligibility::rejected(
                    "JPEG CPU lossless SOF3 YCbCr decode currently supports 4:4:4 sampling, even-width 16-bit 4:2:2 sampling, or even-dimension 16-bit 4:2:0 sampling",
                ),
                _ => JpegBackendEligibility::rejected(
                    "JPEG CPU lossless SOF3 decode currently supports 8-bit Gray8, 16-bit Gray16, 8-bit YCbCr Rgb8/Rgba8, 16-bit YCbCr Rgb16/Rgba16 including even-width 4:2:2 and even-dimension 4:2:0, 8-bit APP14 RGB Rgb8/Rgba8, or 16-bit APP14 RGB Rgb16/Rgba16 including even-width 4:2:2 and even-dimension 4:2:0 output only",
                ),
            };
        }
        SofKind::Lossless => {
    ...
    info.sampling.len() == 3
        && matches!(
            ...
            (_, _, _, 1, 1, [(1, 1), (1, 1), (1, 1)])
                | (16, true, _, 2, 1, [(2, 1), (1, 1), (1, 1)])
                | (16, true, true, 2, 2, [(2, 2), (1, 1), (1, 1)])
        )
}
