...
pub(crate) use signinum_profile::duration_us_string;
use signinum_profile::{
...
pub(crate) fn emit_jpeg_profile_row(op: &str, path: &str, fields: &[(&str, &str)]) {
    signinum_profile::emit_profile_row_with_timing_summary(
...
mod tests {
    ...
    fn profile_summary_groups_rows_and_averages_timing_fields() {
        ...
        signinum_profile::record_timing_summary_str(
            &mut summary,
            "jpeg",
            "decode",
            "cpu",
