...
fn safe_encode_resident_apis_reject_foreign_context_buffers() {
    ...
    assert_encode_context_mismatch(
        crate::J2kCudaEngine::new(&context).j2k_deinterleave_strided_to_f32_resident(
    ...
    assert_encode_context_mismatch(
        crate::J2kCudaEngine::new(&context).j2k_forward_rct_resident(&mut foreign_components),
    );
    assert_encode_context_mismatch(
        crate::J2kCudaEngine::new(&context).j2k_forward_ict_resident(&mut foreign_components),
    );
    assert_encode_context_mismatch(
    ...
    assert_encode_context_mismatch(
        crate::J2kCudaEngine::new(&context).j2k_quantize_subband_resident(
            &foreign_pixels,
            0,
            QUANTIZATION,
        ),
    ...
    assert_encode_context_mismatch(
        crate::J2kCudaEngine::new(&context).j2k_quantize_subband_region_resident(
            &foreign_pixels,
