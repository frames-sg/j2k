...
impl crate::J2kCudaEngine<'_> {
    ...
    pub fn j2k_deinterleave_to_f32_resident(
        ...
        Ok(CudaJ2kResidentComponents {
            ...
            num_pixels,
            num_components,
            execution: CudaExecutionStats::new(1, 0, 0, false),
        })
    }
    ...
    pub fn j2k_deinterleave_strided_to_f32_resident(
        ...
        self.j2k_deinterleave_strided_to_f32_resident_impl(image)
    }

    pub(in crate::j2k_encode) fn j2k_deinterleave_strided_to_f32_resident_impl(
        &self,
        image: CudaJ2kStridedInterleavedPixels<'_>,
    ) -> Result<CudaJ2kResidentComponents, CudaError> {
        ...
        validate_encode_buffer_context(self.context, [pixels])?;
        if width == 0 || height == 0 {
            return Err(CudaError::InvalidArgument {
        ...
        let output_bytes = sample_count
            ...
            .ok_or(CudaError::LengthTooLarge { len: sample_count })?;
        let output = self.allocate(output_bytes)?;
        let launch = J2kStridedDeinterleaveLaunch {
            pixels,
            output: &output,
            width,
            height,
        ...
        self.launch_j2k_deinterleave_strided_to_f32(launch)?;
    ...
    pub fn j2k_forward_rct_resident(
        ...
        validate_encode_buffer_context(self.context, [&components.buffer])?;
        ...
        Ok(CudaExecutionStats::new(1, 0, 0, false))
    }
