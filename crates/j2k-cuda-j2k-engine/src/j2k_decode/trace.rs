...
pub(crate) fn idwt_batch_trace_row(
    ...
    profile: CudaJ2kIdwtBatchStageProfile,
) -> CudaJ2kIdwtBatchTraceRow {
    ...
    CudaJ2kIdwtBatchTraceRow {
        ...
        interleave_horizontal_us: profile.interleave_horizontal_us,
        vertical_us: profile.vertical_us,
    }
}
...
pub(crate) fn format_idwt_batch_trace_row(row: CudaJ2kIdwtBatchTraceRow) -> String {
    format!(
        "j2k_profile codec=j2k op=cuda_idwt_batch path=decode \
         stage_index={} final_stage={} mode={:?} job_count={} max_width={} max_height={} \
         min_width={} min_height={} total_pixels={} irreversible_jobs={} elapsed_us={} \
         interleave_horizontal_us={} vertical_us={}",
        row.stage_index,
        row.final_stage,
        row.mode,
        row.job_count,
