...
mod kernels {
    use crate::{
        ...
        dwt97::{
            j2k_fdwt97_high2_col, j2k_fdwt97_high2_row, j2k_fdwt97_low2_col,
            j2k_fdwt97_low2_row,
        },
        helpers::{
            floor_f32, forward_ict_rgb, load_f32, load_f32_u64, load_job, load_u8, load_u32,
            sign_extend_u32, store_f32, store_f32_u64, store_i32, store_u8, store_u32,
        },
        packetization::{
    ...
    pub unsafe fn j2k_forward_ict(plane0: *mut f32, plane1: *mut f32, plane2: *mut f32, len: u64) {
        ...
        let g = load_f32_u64(plane1.cast_const(), idx);
        let b = load_f32_u64(plane2.cast_const(), idx);
        let (y, cb, cr) = forward_ict_rgb(r, g, b);
        store_f32_u64(plane0, idx, y);
        store_f32_u64(plane1, idx, cb);
        store_f32_u64(plane2, idx, cr);
    }
