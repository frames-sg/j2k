...
pub(crate) struct CudaJ2kIdwtBatchTraceRow {
    ...
    pub(crate) interleave_horizontal_us: u128,
    pub(crate) vertical_us: u128,
}

pub use self::idwt::{CudaJ2kIdwtBatchStageProfile, CudaJ2kIdwtNormalization};
pub use self::store::CudaQueuedJ2kStoreBatch;
#[cfg(test)]
