...
use crate::{
    ...
    htj2k_encode::CudaHtj2kCompactEncodedCodeBlocks,
...
impl crate::J2kCudaEngine<'_> {
    ...
    pub fn encode_htj2k_codeblocks_resident(
        ...
        validate_htj2k_encode_context(self.context, [coefficients], None, None)?;
        let resources = self.upload_htj2k_encode_resources(tables)?;
    ...
    pub fn encode_htj2k_codeblocks_resident_with_resources_and_pool(
        ...
        validate_htj2k_encode_context(self.context, [coefficients], Some(resources), Some(pool))?;
        if jobs.is_empty() {
