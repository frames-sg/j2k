...
const MODULES: &[(&str, &str, usize)] = &[
    ...
    (
        "jpeg/encode_staging.rs",
        include_str!("encode_staging.rs"),
        200,
    ),
    (
        "jpeg/encode_staging_execution.rs",
        include_str!("encode_staging_execution.rs"),
        325,
    ),
    (
        "jpeg/encode_staging_launch.rs",
        include_str!("encode_staging_launch.rs"),
        225,
    ),
    (
    ...
    (
        "jpeg/validation/tests/decode_security/launch_geometry.rs",
        include_str!("validation/tests/decode_security/launch_geometry.rs"),
        100,
    ),
];
...
fn cuda_jpeg_runtime_uses_focused_real_modules() {
    ...
    for module in [
        ...
        "mod encode_launch;",
        "mod encode_staging;",
        "mod encode_staging_execution;",
        "mod encode_staging_launch;",
