...
`j2k` is an independent implementation. The following prior work was used as **reference material** during design and verification, or is included as small test/data assets where noted:
