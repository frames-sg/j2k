...
WSI, Mirax, Leica, Ventana, Philips TIFF, or other vendor containers.
...
the API on real slide workloads: SVS, NDPI, DICOM WSI, Mirax, Hamamatsu VMS,
Leica, Ventana, and Philips TIFF readers resolve compressed tile bytes and
pass decode work to \signinum{}. The companion parity harness compares reader
output against compatibility oracles including OpenSlide, while the \signinum{}
benchmark harness compares codec tasks against
